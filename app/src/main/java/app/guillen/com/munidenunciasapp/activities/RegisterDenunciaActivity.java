...
public class RegisterDenunciaActivity extends AppCompatActivity {
    ...
    public void callRegisterDenuncia(View view) {
        ...
        if (titulo.isEmpty() || latitud.isEmpty() || longitud.isEmpty()) {
            Toast.makeText(this, "Titulo y direccion son campos requeridos", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if (mediaFileUri == null) {
            ...
            call = service.createDenuncia(titulo,comentario,latitud,longitud,"2");
        } else {
            ...
            RequestBody users_idPart = RequestBody.create(MultipartBody.FORM, "2");

            call = service.createDenunciaWithImage(tituloPart, comentarioPart, latitudPart, longitudPart, imagenPart, users_idPart);
        }
